package com.gradu.data.datasource.schedule
...
class RemoteScheduleDataSource @Inject constructor(
    ...
    private val moimApiService: MoimApiService,
) {
    /** 개인 */
    // 일정 조회
    ...
    suspend fun getMoimSchedules(): GetMoimResponse {
        ...
        withContext(Dispatchers.IO) {
            runCatching {
                moimApiService.getMoimCalendarSchedule()
            }.onSuccess {
    ...
    suspend fun getMoimSchedueDetail(
        ...
        withContext(Dispatchers.IO) {
            runCatching {
                moimApiService.getMoimScheduleDetail(moimScheduleId)
            }.onSuccess {
    ...
    suspend fun addMoimSchedule(
        ...
        withContext(Dispatchers.IO) {
            runCatching {
                moimApiService.postMoimSchedule(moimSchedule)
            }.onSuccess {
    ...
    suspend fun editMoimSchedule(
        ...
        withContext(Dispatchers.IO) {
            runCatching {
                moimApiService.editMoimSchedule(moimId, moimSchedule)
            }.onSuccess {
                scheduleResponse = it
    ...
    suspend fun deleteMoimSchedule(
        ...
        withContext(Dispatchers.IO) {
            runCatching {
                moimApiService.deleteMoimSchedule(moimScheduleId)
            }.onSuccess {
                scheduleResponse = it
    ...
    suspend fun editMoimScheduleProfile(
        ...
        withContext(Dispatchers.IO) {
            runCatching {
                moimApiService.editMoimScheduleProfile(moimScheduleId, request)
            }.onSuccess {
                scheduleResponse = it
    ...
    suspend fun getGuestInvitationLink(
        ...
        withContext(Dispatchers.IO) {
            runCatching {
                moimApiService.getGuestInvitationLink(moimScheduleId)
            }.onSuccess {
                scheduleResponse = it
