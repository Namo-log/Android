...
class CalendarUtils {
    companion object {
        ...
        fun getMonthList(dateTime: DateTime): List<DateTime> {
            ...
            val prev = com.gradu.core.utils.CalendarUtils.Companion.getPrevOffset(date)

            val startValue = date.minusDays(prev).withTimeAtStartOfDay()

            val totalDay = DateTimeConstants.DAYS_PER_WEEK * com.gradu.core.utils.CalendarUtils.Companion.WEEKS_PER_MONTH
...
//            }
        ...
        fun getTodaySchedule(eventList: ArrayList<Schedule>, today: DateTime): ArrayList<Schedule> {
            ...
            eventList.forEach {
                if (com.gradu.core.utils.CalendarUtils.Companion.isScheduleHaveToday(it, today)) {
                    contains.add(it)
                }
            }
