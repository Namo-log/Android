...
class DiaryService {
    private val diaryRetrofitInterface: DiaryInterface = ApplicationClass.bRetrofit.create(DiaryInterface::class.java)
    ...
    fun addDiary(
        ...
        diaryRetrofitInterface.addDiary(imgs,content,scheduleIdx).enqueue(object : Callback<DiaryResponse.DiaryAddResponse> {

            override fun onResponse(call: Call<DiaryResponse.DiaryAddResponse>,
    ...
    fun editDiary(
        ...
        diaryRetrofitInterface.editDiary(imgs,content,scheduleIdx).enqueue(object : Callback<DiaryResponse.DiaryEditResponse> {

            override fun onResponse(call: Call<DiaryResponse.DiaryEditResponse>,
    ...
    fun deleteDiary(
        ...
        diaryRetrofitInterface.deleteDiary(scheduleIdx).enqueue(object : Callback<DiaryResponse.DiaryDeleteResponse> {

            override fun onResponse(call: Call<DiaryResponse.DiaryDeleteResponse>,
            ...
            override fun onFailure(call: Call<DiaryResponse.DiaryDeleteResponse>, t: Throwable) {
    ...
    fun getMonthDiary(
        ...
        diaryRetrofitInterface.getMonthDiary(month).enqueue(object : Callback<DiaryResponse.DiaryGetMonthResponse> {

            override fun onResponse(call: Call<DiaryResponse.DiaryGetMonthResponse>,
                                    response: Response<DiaryResponse.DiaryGetMonthResponse>) {
                val resp: DiaryResponse.DiaryGetMonthResponse=response.body()!!
                when (val code =resp.code){
                    200->getMonthDiaryView.onGetMonthDiarySuccess(code,resp.message,resp.result)
                }
            }

            override fun onFailure(call: Call<DiaryResponse.DiaryGetMonthResponse>, t: Throwable) {
