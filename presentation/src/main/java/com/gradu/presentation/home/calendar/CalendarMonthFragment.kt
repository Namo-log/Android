package com.gradu.presentation.ui.home.calendar
...
import com.gradu.presentation.ui.home.diary.PersonalDiaryDetailActivity
import com.gradu.presentation.ui.community.moim.diary.MoimDiaryDetailActivity
import com.gradu.presentation.ui.home.HomeFragment
...
class CalendarMonthFragment : BaseFragment<FragmentCalendarMonthBinding>(R.layout.fragment_calendar_month) {
    ...
    private fun setCategoryList(categoryList: List<CategoryModel>) {
